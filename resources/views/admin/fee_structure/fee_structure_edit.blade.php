...
@endif
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{route('fee_structure.update')}}" method="post">
                @csrf
                ...
                <div class="card-body">
                    <div class="row">
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <select class="form-control" name="fee_head_id" id="">
                            ...
                            @foreach ($fee as $item)
                                <option value="{{ $item->id }}"
                                    @if ($data->fee_head_id == $item->id) selected @endif>
                                    {{ $item->name }}
                                </option>
                            @endforeach
                        </select>
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="april" value="{{$data->april}}"  class="form-control" id="exampleInputEmail1" >
                  </div>
                  @error('april')
                      <p class="text-danger">
                        {{$message}}
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="may" value="{{$data->may}}"   class="form-control" id="exampleInputEmail1" placeholder="Enter May Fee">
                  </div>
                  @error('may')
                      <p class="text-danger">
                        {{$message}}
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="june" value="{{$data->june}}"   class="form-control" id="exampleInputEmail1" placeholder="Enter June Fee">
                  </div>
                  @error('june')
                      <p class="text-danger">
                        {{$message}}
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="july" value="{{$data->july}}"   class="form-control" id="exampleInputEmail1" placeholder="Enter July Fee">
                  </div>
                  @error('july')
                      <p class="text-danger">
                        {{$message}}
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="august" value="{{$data->august}}"   class="form-control" id="exampleInputEmail1" placeholder="Enter August Fee">
                  </div>
                  @error('august')
                      <p class="text-danger">
                        {{$message}}
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="september" value="{{$data->september}}"   class="form-control" id="exampleInputEmail1" placeholder="Enter September Fee">
                  </div>
                  @error('september')
                      <p class="text-danger">
                        {{$message}}
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="october" value="{{$data->october}}"   class="form-control" id="exampleInputEmail1" placeholder="Enter October Fee">
                  </div>
                  @error('october')
                      <p class="text-danger">
                        {{$message}}
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="november" value="{{$data->november}}"   class="form-control" id="exampleInputEmail1" placeholder="Enter November Fee">
                  </div>
                  @error('november')
                      <p class="text-danger">
                        {{$message}}
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="december" value="{{$data->december}}"   class="form-control" id="exampleInputEmail1" placeholder="Enter December Fee">
                  </div>
                  @error('december')
                      <p class="text-danger">
                        {{$message}}
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="january" value="{{$data->january}}"   class="form-control" id="exampleInputEmail1" placeholder="Enter January Fee">
                  </div>
                  @error('january')
                      <p class="text-danger">
                        {{$message}}
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="february" value="{{$data->february}}"   class="form-control" id="exampleInputEmail1" placeholder="Enter February Fee">
                  </div>
                  @error('february')
                      <p class="text-danger">
                        {{$message}}
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="march" value="{{$data->march}}"   class="form-control" id="exampleInputEmail1" placeholder="Enter  March Fee">
                  </div>
                  @error('march')
                      <p class="text-danger">
                        {{$message}}
