    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Exam</h1>
            <a href="{{route('exam_result.read')}}" class="btn btn-primary mt-2"> View Exam Result</a>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            @endif
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{route('exam_result.update')}}" method="post">
                @csrf
                        ...
                        <select class="form-control" name="exam_id" id="">
                            ...
                            @foreach ($exam as $item)
                                <option value="{{ $item->id }}"
                                    @if ($data->exam_id == $item->id) selected @endif>
                                    {{ $item->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control" name="user_id" id="">
                            ...
                            @foreach ($student as $item)
                                <option value="{{ $item->id }}"
                                    @if ($data->user_id == $item->id) selected @endif>
                                    {{ $item->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" name="score"  value="{{$data->score}}" class="form-control" id="name" placeholder="Enter Exam Term">
                    @error('score')
