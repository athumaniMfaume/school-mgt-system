                ...
                <div class="card-body">
                  ...
                  <div class="row">
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <input type="text" name="name" class="form-control" id="name" placeholder="Enter Exam Name">
                        @error('name')
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" name="term" class="form-control" id="name" placeholder="Enter Exam Term">
                        @error('term')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="date" name="date" class="form-control" id="admission_date">
                        @error('date')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
