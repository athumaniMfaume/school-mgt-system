            ...
            @endif
              ...
              <form action="{{route('exam.update')}}" method="post">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" name="name" value="{{$data->name}}"  class="form-control" id="name" placeholder="Enter Exam Name">
                    @error('name')
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" name="term"  value="{{$data->term}}" class="form-control" id="name" placeholder="Enter Exam Term">
                    @error('term')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="date" name="date" value="{{$data->date}}" class="form-control" id="admission_date">
                    @error('date')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div>
