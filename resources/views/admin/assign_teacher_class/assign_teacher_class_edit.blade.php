        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Assign Teacher Class</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            @endif
              <div class="card-header">
                <h3 class="card-title">Update Teacher Class</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{route('teacher_class.update')}}" method="post">
                @csrf
