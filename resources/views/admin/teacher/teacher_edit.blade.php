          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form action="{{route('teacher.update')}}" method="post">
                ...
                <div class="form-group col-md-4">
                    <label for="exampleInputEmail1">Teacher's Phone</label>
                ...
                <div class="form-group col-md-4">
                    <label for="exampleInputEmail1">Teacher's Email</label>
                ...
                @enderror
                  ...
                  <div class="form-group col-md-4">
                    <label for="exampleInputEmail1">Teacher's Password</label>
