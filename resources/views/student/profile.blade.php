...
@else
    <img 
        class="profile-user-img img-fluid img-circle"
        src="{{ asset('admins/dist/img/user4-128x128.jpg') }}"
...
@endif
                ...
                <p class="text-muted text-center">{{$user->classes->name}}</p>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  ...
                  <li class="nav-item"><a class="nav-link" href="#edit-info" data-toggle="tab">Edit Info</a></li>
  ...
  <div class="col-sm-10">
    <p class="form-control-plaintext mb-0">{{$user->name}}</p>
  </div>
</div>
...
<div class="form-group row">
  ...
  <div class="col-sm-10">
    <p class="form-control-plaintext mb-0">{{$user->classes->name}}</p>
  </div>
</div>
...
@endif
                    <form action="{{route('profile.edit')}}" method="post" class="form-horizontal">
                        @csrf
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">Name</label>
                        <div class="col-sm-10">
                          <input type="text"  name="name" class="form-control" id="inputName" value="{{ old('name', $user->name) }}" placeholder="Name">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail" class="col-sm-2 col-form-label">Email</label>
                        <div class="col-sm-10">
                          <input type="email" name="email" class="form-control" id="inputEmail" value="{{ old('email', $user->email) }}" placeholder="Email">
                        </div>
                      </div>
...
@endif
                    <form action="{{ route('changepassword.post') }}" method="post" class="form-horizontal">
                        @csrf
                      <div class="form-group row">
