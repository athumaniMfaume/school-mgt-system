...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{route('student.mySubject')}}" class="nav-link">Subject</a>
      </li>
    </ul>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('student.exam_result')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{route('student.myTimeTable')}}" class="nav-link">
...
@yield('content')
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2024 <a href="https://adminlte.io">School Management System</a>.</strong>
    All rights reserved.
